...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="/${ ui.contextPath() }/images/smartacare-favicon.ico"/>
    <link rel="icon" type="image/png\" href="/${ ui.contextPath() }/images/smartacare-favicon.png"/>
    ${ ui.resourceLinks() }
</head>
<body>
...
<header>
    <div class="logo">
        <a href="${ui.pageLink("referenceapplication", "home")}">
            <img src="${ui.resourceLink("mapperoverridedemo", "/images/smartacareLogo.png")}"/>
        </a>
    </div>
</header>
